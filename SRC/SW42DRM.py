...
matlab_path='/home/hexiang/git/SW42DRM/SRC/sw4_tools';
########################## Ending usr input ####################################################################
...
filename_x='E_000_000_000.x'
filename_y='E_000_000_000.y'
filename_z='E_000_000_000.z'

[u_x, dt, lat, lon, b, e, npts, year, jday, hour, min, sec, msec, cmpaz, cmpinc, idep, stnam ]=eng.readsac(filename_x);
[u_y, dt, lat, lon, b, e, npts, year, jday, hour, min, sec, msec, cmpaz, cmpinc, idep, stnam ]=eng.readsac(filename_y);
[u_z, dt, lat, lon, b, e, npts, year, jday, hour, min, sec, msec, cmpaz, cmpinc, idep, stnam ]=eng.readsac(filename_z);
