...
translation_base_station_index_x=0;
translation_base_station_index_y=3;
translation_base_station_index_z=5;
rotation_base_station_index_x=0;
rotation_base_station_index_y=3;
rotation_base_station_index_z=5;
# ################################# Ending input ####################################################
...
x_rotation=0;  #the degree of rotating along x axis based on base station, degree is positive for clockwise, right hand rule for positive direction of x
y_rotation=0;  #the degree of rotating along y axis based on base station, degree is positive for clockwise, right hand rule for positive direction of y
z_rotation=30;  #the degree of rotating along z axis based on base station, degree is positive for clockwise,right hand rule for positive direction of z
